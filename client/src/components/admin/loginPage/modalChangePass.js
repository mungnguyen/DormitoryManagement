    ...
    class ModalChangePass extends Component {
        ...
        doiMatKhau = () => {
            if (this.state.matKhauMoi) {
                this.props.doiMatKhauAdmin("12345", this.state.matKhauMoi);
                this.setState({
                    matKhauMoi: "",
                    xacNhan: ""
                });
        ...
        render() {
            return (
                <Modal isOpen={this.props.open}>
                    ...
                    <ModalFooter>
                        <Button outline color="primary" onClick={this.props.doiMatKhau}>OK</Button>
                    </ModalFooter>
                </Modal>
            );
        }
...
export default connect(mapStatetoProps, mapActiontoProps)(ModalChangePass);